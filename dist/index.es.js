...
var getSize = function getSize() {
  return function (props) {
    ...
    return css(_templateObject(), size, size, margin);
  };
};

var Dots = styled.div(_templateObject2());
var Dot = styled.div(_templateObject3(), getSize(), function (props) {
...
function Dots$1(_ref) {
  ...
  return React.createElement(Dots, null, _toConsumableArray(Array(totalSlides)).map(function (_, idx) {
...
var Slide = styled.div(_templateObject$1());
...
function Slide$1(_ref) {
  ...
  return React.createElement(AnimatedSlide, {
    ref: element,
    style: {
...
var SlideIndicator = styled.div(_templateObject$2());
...
function SlideIndicator$1(_ref) {
  ...
  return React.createElement(React.Fragment, null, transitions.map(function (_ref2) {
    var item = _ref2.item,
        key = _ref2.key,
        props = _ref2.props;
    return item && React.createElement(AnimatedSlideIndicator, {
      key: key,
      inFront: inFront,
...
var Slider = styled.div(_templateObject$3(), function (props) {
  return props.isZooming ? 20 : 0;
});
var Overlay = styled.div(_templateObject2$1());
var SlideOverlay = styled.div(_templateObject3$1(), function (props) {
...
function Slider$1(_ref) {
  ...
  return React.createElement("div", null, zooming && React.createElement(AnimatedOverlay, {
    style: {
  ...
  }), React.createElement(SlideOverlay, {
    inFront: !zooming
  }, slideOverlay, React.createElement(SlideIndicator$1, {
    slideIndicatorTimeout: slideIndicatorTimeout,
    currentSlide: currentSlide,
    totalSlides: slides.length
  })), React.createElement(AnimatedSlider, _extends({
  ...
  })), slides.length > 1 && React.createElement(Dots$1, {
    totalSlides: slides.length,
    currentSlide: currentSlide,
...
export { Dots$1 as Dots, Slide$1 as Slide, SlideIndicator$1 as SlideIndicator, Overlay as StyledOverlay, SlideOverlay as StyledSlideOverlay, Slider as StyledSlider, useSlider, useZoom };
